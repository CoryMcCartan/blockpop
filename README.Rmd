...
are based on new roads and map data, to estimate 2020 block populations, both
overall and by major race/ethnicity categories (using iterative proportional
fitting).
...
Then we call `harmonize_vars()` to create block-level estimates
